<div class="main" id="printableArea">
	...
	<div class="table-div">
		<div class="w-50">
			<span class="text">Shift: {{ $print_data->shift }}</span>
		</div>
		<div class="w-50 text-right">
			<span class="text">Date: {{ $print_data->date }} </span>
		</div>
	</div>
	<table style="width:100%;margin: -1;" border="1" cellpadding="4" cellspacing="0" >
        <tr>
            <td>Shift UPI Collection</td>
            <td><b>@{{print_data->total_upi_collection }}</b></td>
        </tr>
        <tr>
            <td>Shift Cash Collection</td>
            <td><b>@{{print_data->total_cash_collection }}</b></td>
        </tr>
        <tr>
